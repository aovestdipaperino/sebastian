...
- **`handDrawnStraightEdges` init option.** With `look: handDrawn`, setting
  ...
  to dagre's routed points, simplified (nearly collinear points dropped) and
  drawn as straight runs; cluster-bound edges and self-loops keep their
  routed points too. Ignored in the classic look.
