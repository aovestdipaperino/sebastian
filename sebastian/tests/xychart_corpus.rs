//! Corpus test: xychart-beta charts with official mermaid-cli (mermaid 11.15.0)
...
#[test]
fn xychart_corpus() {
    let dir = format!("{}/tests/xychart_cases", env!("CARGO_MANIFEST_DIR"));
    let mut cases: Vec<String> = std::fs::read_dir(&dir)
        .expect("xychart_cases dir")
        .filter_map(|e| {
